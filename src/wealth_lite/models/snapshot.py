...
class PortfolioSnapshot:
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        return {
            ...
            'total_return_rate': float(self.total_return_rate),
            'cash_value': float(self.cash_value),
            'fixed_income_value': float(self.fixed_income_value),
            'equity_value': float(self.equity_value),
            'real_estate_value': float(self.real_estate_value),
            'commodity_value': float(self.commodity_value),
