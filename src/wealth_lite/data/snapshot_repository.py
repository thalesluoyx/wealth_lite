    ...
    def save(self, snapshot: PortfolioSnapshot) -> bool:
        ...
        try:
            ...
            params = (
                ...
                float(snapshot.total_return_rate),
                float(snapshot.cash_value),
                float(snapshot.fixed_income_value),
                float(snapshot.equity_value),
                float(snapshot.real_estate_value),
                float(snapshot.commodity_value),
